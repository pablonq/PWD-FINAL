        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form name="formLogin" id="formLogin" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="d-grid mb-3 gap-2">
                        <button type="submit" id="botonLogin" class="btn btn-dark ingresar"
                            name="botonLogin">INGRESAR</button>
                    </div>
            ...
            <div class="modal-footer">
                <div class="d-grid gap-2 col-6 mx-auto">
                    <a class="btn btn-outline-secondary crearcta" data-bs-toggle="modal"
                        data-bs-target="#modalCrearCuenta" tabindex="-1" data-bs-toggle="modal">Crear Cuenta</a>
                </div>
            </div>
        </div>
    </div>
